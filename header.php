...
$noindex_pages = ['register','forgot-password','reset-password','otp-verify','resend-otp','checkout','payment-pending','check-payment-status','google-callback','download-product','logout','success','cancel','dashboard','lesson','lesson_progress_ajax','challenge','coding-challenges','coding-submissions'];
